...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        //check if the movement puts the player in check
        ...
        //check if en passant can be achieved
    ...
    private Piece makeMove(Position source, Position target) {
        ...
        p.increaseMoveCount();
        //logic for capturing pieces if there are any in the way
    ...
    private boolean testCheck(Color color) {
        ...
        //check if in any of the opponent pieces there are moves that can capture the king
